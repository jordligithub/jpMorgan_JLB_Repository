...
public class StockCommon extends Stock {
    ...
    public StockCommon(String symbol, String type, double parValue, double lastDividend, double fixedDividend, double tickerMeanPrice, ArrayList<Ticker> tickers) {
    ...
    protected double calculateDividendYield() {
        ...
        if (this.tickerMeanPrice == 0) {
            ...
            return this.dividenYield = this.lastDividend / this.tickerMeanPrice;
        }
